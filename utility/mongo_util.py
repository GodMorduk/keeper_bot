...
stats_list_for_gms = [
    "поток красный", "поток синий", "поток индиго", "поток золотой", "поток серебряный", "атрибут сила",
    "атрибут восприятие", "атрибут выносливость", "атрибут рефлексы", "атрибут ловкость", "атрибут удача",
    "усилие воздействие", "усилие знание", "усилие размышление", "усилие уверенность", "усилие репутация",
    "особое эститенция", "особое ордеция", "особое перки"
]
...
def beautify_char_stats(stats):
    ...
    left_est = est - mng.count_all_stats(stats)
